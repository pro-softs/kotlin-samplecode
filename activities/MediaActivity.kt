...
import app.pr0.com.aquariumcamera.R
import app.pr0.com.aquariumcamera.adapters.MediaAdapter
import app.pr0.com.aquariumcamera.asynctasks.GetMediaAsynctask
import app.pr0.com.aquariumcamera.dialogs.ChangeSortingDialog
import app.pr0.com.aquariumcamera.dialogs.ExcludeFolderDialog
import app.pr0.com.aquariumcamera.dialogs.FilterMediaDialog
import app.pr0.com.aquariumcamera.extensions.*
import app.pr0.com.aquariumcamera.helpers.*
import app.pr0.com.aquariumcamera.helpers.GET_IMAGE_INTENT
import app.pr0.com.aquariumcamera.helpers.GET_VIDEO_INTENT
import app.pr0.com.aquariumcamera.helpers.SHOW_TEMP_HIDDEN_DURATION
import app.pr0.com.aquariumcamera.models.Medium
    ...
    private fun getMedia() {
        ...
        if (!mLoadedInitialPhotos) {
            getCachedMedia(mPath) {
                if (it.isEmpty()) {
                    runOnUiThread { media_refresh_layout.isRefreshing = true }
                } else {
                    gotMedia(it, true)
                }
            }
