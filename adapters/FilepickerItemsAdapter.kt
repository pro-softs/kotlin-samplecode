        ...
        if (!activity.isActivityDestroyed()) {
            Glide.with(activity)
                    .applyDefaultRequestOptions(RequestOptions().
                            disallowHardwareConfig()).clear(holder.itemView?.list_item_icon!!)
        }
    }
        ...
        view.apply {
            ...
            if (fileDirItem.isDirectory) {
                ...
                if (!activity.isActivityDestroyed()) {
                    ...
                    Glide.with(activity)
                            .applyDefaultRequestOptions(RequestOptions().
                                    disallowHardwareConfig()).load(itemToLoad).transition(withCrossFade()).apply(options).into(list_item_icon)
                }
            }
        }
    }
